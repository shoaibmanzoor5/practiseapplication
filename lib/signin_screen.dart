        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("SignIn",style: TextStyle(fontSize: 30.sp,fontWeight: FontWeight.bold,color: atextblueColor),),
              ...
              Padding(
                padding:  EdgeInsets.only(right: 180.w),
                  ...
                  child: TextButton(
                      child: Text(
                        'Forget Password', style: TextStyle(fontSize: 14.sp,
              ...
              SizedBox(height: 20.h,),
              getcontainer(txt: 'SignUp', callforwed: () {   Navigator.push(
                context,
